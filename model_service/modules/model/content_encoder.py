...
from .base_network import BaseNetwork, AdaptiveInstanceNorm
...
class Conv2dBlock(BaseNetwork):
    def __init__(self, fin, fout, kernel_size, padding, stride, param_free_norm_type='none', activation='relu'):
        ...
        self.conv = spectral_norm(
            nn.Conv2d(fin, fout, kernel_size=kernel_size, padding=padding, stride=stride, padding_mode='reflect')
        )
